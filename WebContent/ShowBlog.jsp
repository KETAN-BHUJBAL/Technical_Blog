...
<nav class="navbar navbar-expand-lg navbar-dark primary-background ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
     ...
     <li class="nav-item">
        <a class="nav-link" href="Profile.jsp"><span class="fa fa-address-card"></span>Timeline </a>
      </li>
    ...
    <div class="modal-content">
     ...
     <div class="form-grpup">
      ...
      <%PostDao p1=new PostDao(ConnectionProvider.getConnection()) ;
         ArrayList<Category> list= p1.getAllCategories(); 
         for(Category c:list){
         %>
...
<div class="card-body ">
<p class="post-id">PostID:<%=p.getPid() %></p>
<p class="post-contain">Content: <%=p.getPcontent() %></p>
<div class="row my-3 row-user">
<div class="col-md-8">
<%UserDao ud=new UserDao(ConnectionProvider.getConnection()); 
%>
<p class="post-userimfo">PostID:<a href="#!" ><%=p.getCid()%></a> has posted:</p>
...
%>
<a href="#"  onclick="dLiked(<%=p.getPid() %>,<%=user.getId() %>)" class="btn primary-background  text-white"><i class="fa fa-thumbs-o-up"></i><span class="like-counter"><%=ld.countLike(p.getPid()) %></span></a>
<a href="#" class="btn primary-background  text-white"><i class="fa fa-commenting-o "></i><span></span></a>
